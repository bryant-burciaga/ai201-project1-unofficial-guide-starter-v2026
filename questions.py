...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question":"What does the Brightwater transportation guide say about traveling during the Winter time?","expects": "Winter is cold and several riverside businesses close entirely from January to March."},
    {"question":"What does the city_guide say is the best place to stay in when visiting Thornby Wells  based on budget?", "expects": "The pump room is open and free, as is the Parking which is free for two hours everywhere in town."},
    {"question":"When is it best to use a bike, bus, rideshare, or walk according to the city_guide for Elder Ness?", "expects": "There is one car park at the village and parking anywhere else on the headland is prohibited and enforced."},
    {"question":"What is best place to stay in town during the winter time according to city_guide for Corry Vale","expects":"Camping permitted, but gets boggy in winter. 30 rooms in 2 pubs and farmhouses available, but booked months in advance."},
    {"question":"What does city_guide best recommendation for food when eating in the area amongst all these locations?", "expects": "Almost everywhere."},
]
